...
export { Airplane } from './Admin/Airplane';
export { Airplanes } from './Admin/Airplanes';
export { Booking } from './Admin/Booking';
export { Destinations } from './Admin/Destinations';
export { Flights } from './Admin/Flights';
